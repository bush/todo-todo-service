...
export declare class LoggerFactory {
    static create(strategy?: string): INimkeeLogger;
}
...
declare namespace NIMKEE {
    export {
        ...
        NimkeeElectroDBConfig,
        NimkeeMongooseConfig,
 ...
 * @public
 */
export declare type NimkeeDBMapperConfig = {
 ...
 * @public
 */
export declare type NimkeeElectroDBConfig = {
    tableName: string;
};
 ...
 * @public
 */
export declare type NimkeeMongooseConfig = {};
