...
export declare class DeleteCommand extends DynamoDBDocumentClientCommand<DeleteCommandInput, DeleteCommandOutput, __DeleteItemCommandInput, __DeleteItemCommandOutput, DynamoDBDocumentClientResolvedConfig> {
    ...
    protected readonly inputKeyNodes: {
        Key: import("@aws-sdk/lib-dynamodb/dist-types/commands/utils").KeyNodeChildren;
        Expected: {
            "*": {
                Value: null;
    ...
    protected readonly outputKeyNodes: {
        Attributes: import("@aws-sdk/lib-dynamodb/dist-types/commands/utils").KeyNodeChildren;
        ItemCollectionMetrics: {
            ItemCollectionKey: import("@aws-sdk/lib-dynamodb/dist-types/commands/utils").KeyNodeChildren;
        };
    };
