 ...
 */
export * from "@aws-sdk/client-dynamodb/dist-types/DynamoDBClient";
export * from "@aws-sdk/client-dynamodb/dist-types/DynamoDB";
export { ClientInputEndpointParameters } from "@aws-sdk/client-dynamodb/dist-types/endpoint/EndpointParameters";
export { RuntimeExtension } from "@aws-sdk/client-dynamodb/dist-types/runtimeExtensions";
export { DynamoDBExtensionConfiguration } from "@aws-sdk/client-dynamodb/dist-types/extensionConfiguration";
export * from "@aws-sdk/client-dynamodb/dist-types/commands";
export * from "@aws-sdk/client-dynamodb/dist-types/pagination";
export * from "@aws-sdk/client-dynamodb/dist-types/waiters";
export * from "@aws-sdk/client-dynamodb/dist-types/models";
export { DynamoDBServiceException } from "@aws-sdk/client-dynamodb/dist-types/models/DynamoDBServiceException";
